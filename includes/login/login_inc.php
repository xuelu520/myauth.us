        ...
        document.getElementById('letters_code').focus();" src="/includes/check/code.php?rand=<?php echo rand(0, 20); ?>" alt="换一个" title="换一个" class="border-5" /></div>
                ...
                <p><label class="label" for="letters_code">
                    ...
                    ?>type="text" onblur="if (!jquerycodechecked) {
                            ...
                            }" style="width:320px;" name="letters_code" maxlength="6" tabindex="2" autocomplete="off"/>&nbsp;&nbsp;<span id="checkyanzhenmaajax"></span>
                           <?php
                           if ($loginerrorid == 2) {
                ...
                <p><span id="remember-me"><label for="persistLogin">
                    ...
                    <button id="creation-submit" class="ui-button button1" type="submit"  data-text="正在处理……" onClick='javascript:return submitcheck();'><span class="button-left"><span class="button-right">
                                登录
                            </span></span></button>
                </p>
            </form>

...
//fixed
?>
<div id="layout-middle" style="height:1582px; ">
    <div id="homewrapper">
        <div id="content">
            <div id="page-content">
                <div id="breadcrumb">
                        ...
                        <div id="article">
                            ...
                            <div id="article-content">
                                <p>
                                    ...
                                    包括且不限于魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄、战网Battle.Net<br>
                                ...
                                <p>
                                    ...
                                    请务必记住您的注册信息，该信息将在您重置密码、更改邮箱地址时使用。请<span style="color:red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄相同的密码，以免发生纠纷<br>
                                    注册前请仔细查看<a href="<?php echo SITEHOST ?>copyright.php">版权声明与免责条款</a>，您未来可能发生的一切账号失窃事件均与本站无关，重复一遍，请<span style="color:red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄相同的密码
                                </p>
                                <p>

...
?>
<div id="layout-middle" style="height: 3967px;">
    <div id="homewrapper">
        <div id="content">
            <div id="page-content">
                <div id="breadcrumb">
                        ...
                        <div id="article">
                            ...
                            <div id="article-content">
                                ...
                                <p>
                                    ...
                                    请<span style="color: red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄相同的密码
                                </p>
                                ...
                                <p>额，你问我，我问谁，我只知道在我的最大限度下能保证本站的安全，您的密码也被加密保存，不会有类似CSDN这种SB事件出现<br>
                                    重复一遍，请<span style="color: red;">绝对</span>不要使用与您战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄相同的密码<br>
                                ...
                                <p>简单的回答:是的<br>
                                    支持我们做得更好，欢迎<a href='<?=SITEHOST;?>donate.php'>捐赠</a>，谢谢
                                </p>

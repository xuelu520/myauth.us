    ...
    <div class="homewrapper">
        <div id="content">
            ...
            if ($changepsderrorid > 0 && $error_html_code[$changepsderrorid] != null)
                echo '<div class="alert error closeable border-4 glow-shadow"><div class="alert-inner"><div class="alert-message"><p class="title"><strong><a name="form-errors"> </a>发生下列错误：</strong></p><ul><li>' . $error_html_code[$changepsderrorid] . '</li></ul></div></div></div>';
            ?>
            <div id="page-header">
                ...
                <div class="columns-2-1 settings-content" style="height: 420px;">
                            ...
                            <form method="post" action="<?php echo SITEHOST; ?>changepwd.php" id="change-settings" novalidate="novalidate">
                                ...
                                <div class="submit-row" id="submit-row">
                                    ...
                                    --><div class="input-right">
                                        <button class="ui-button button1" type="submit" id="password-submit" tabindex="1" onClick='javascript:return submitcheck();'><span class="button-left"><span class="button-right">继续</span></span></button>
                    ...
                    <div class="column column-right">
                        <div class="password-requirements">
                            ...
                            <p class="caption">为了您的安全，我们强烈建议您使用不同于战网、魔兽世界、暗黑破坏神III、炉石传说、风暴英雄及其它任何线上账号密码的密码。</p>
                        </div>
                    </div>
                </div>
            </div>

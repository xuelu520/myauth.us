...
<div id="layout-middle">
    <div id="homewrapper">
        <div id="content">
            <?php
            if ($changemailadderrorid > 0 && $error_html_code[$changemailadderrorid] != null)
                echo '<div class="alert error closeable border-4 glow-shadow"><div class="alert-inner"><div class="alert-message"><p class="title"><strong><a name="form-errors"> </a>发生下列错误：</strong></p><ul><li>' . $error_html_code[$changemailadderrorid] . '</li></ul></div></div></div>';
            ?>
            <div id="page-header">
            ...
            <form id="support-form" class="login-support-form" novalidate="novalidate" action="<?php echo SITEHOST; ?>changemailadd.php" method="post">

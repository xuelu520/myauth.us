                                    ...
                                    <div class="input-row input-row-text">
                                        ...
                                        <span class="input-right">
                                            <div class="imgandreloader">
                                                <div id="captcha-image"><img id="sec-string1" onclick="refreshCaptcha(1);document.getElementById('letters_code1').focus();" src="/includes/check/code.php?rand=8&unix=<?=$yanzhenmaunix;?>" alt="换一个" title="换一个" class="border-5" /></div>
                            ...
                            <div id="character-services" class="content character-services">
                                ...
                                <form action="<?php echo SITEHOST; ?>addbykey.php" method="post" id="creation" novalidate="novalidate">
                                    ...
                                    <div class="input-row input-row-text">
                                        ...
                                        <span class="input-right">
                                            <div class="imgandreloader">
                                                <div id="captcha-image"><img id="sec-string2" onclick="refreshCaptcha(2);document.getElementById('letters_code2').focus();" src="/includes/check/code.php?rand=8&unix=<?=$yanzhenmaunix;?>" alt="换一个" title="换一个" class="border-5" /></div>
                                                <div id="captcha-reloader">
                                                    看不清楚？<br />
                            ...
                            <div id="game-time-subscriptions" class="content game-time-subscriptions"> 
                                <form action="<?php echo SITEHOST; ?>addbyrestore.php" method="post" id="creation" novalidate="novalidate">
                                    ...
                                    <div class="input-row input-row-text">
                                        ...
                                        <span class="input-right">
                                            <div class="imgandreloader">
                                                <div id="captcha-image"><img id="sec-string3" onclick="refreshCaptcha(3);document.getElementById('letters_code3').focus();" src="/includes/check/code.php?rand=8&unix=<?=$yanzhenmaunix;?>" alt="换一个" title="换一个" class="border-5" /></div>
                                                <div id="captcha-reloader">
                                                    看不清楚？<br />

...
function allatthecho($login, $auth_exist, $userid, $userright) {
    global $dbconnect;
    if ($login == 0) {
        $returntxt = "";
        return $returntxt;
                    ...
                    <div id="dashboard" class="dashboard">
                        ...
                        <div class="security-image">
                            ...
                            <div class="auth-info-box">
                                ...
                                <div class="section actions"><ul><li class="remove-authenticator"><a class="icon-delete" href="<?php echo SITEHOST . "delauth.php?authid=" . $rowauth['auth_id']; ?>" onclick="if (confirm('提交后将删除这枚安全令，除重新添加外无其他恢复方法，确定吗？'))
            return true;
        else
            return false;">
                                                删除这枚安全令
                ...
                <div id="lobby-games">
                    <div id="games-list"> 
                        ...
                        <ul id="game-list-wow" style="display: none;">
                            <?php
                            echo allatthecho($logincheck, $autherrid, $user_id, $user_right);

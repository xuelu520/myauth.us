...
function allatthecho($login, $userid, $userright) {
    global $dbconnect;
    if ($login == 0) {
        $returntxt = "";
        return $returntxt;
            ...
            <div id="lobby"><div id="page-content" class="page-content">
                    <div id="lobby-account">
                        ...
                        <div class="lobby-box">
                            ...
                            <p><?php
                                echo strtoupper($rowtemp['user_name']);
                                ?></p>
                            ...
                            <p><?php
                                if ($user_right == 0) {
                                    ...
                                    echo " 共享账号:不能获取序列号和还原码";
                                }
                                ?></p>
                            <h4 class="subcategory">邮箱</h4>
                            <p><?php
                                if ($user_right == 0) {
                                    echo $rowtemp['user_email'];
                                } else {
                                    echo "共享账号隐藏邮箱信息";
                                }
                                ?></p>
                    ...
                    <div id="lobby-games">
                        ...
                        <div id="games-tools">
                            ...
                            <div style="margin-top: 7px;">
                                ...
                                <?php if ($auth_total_all > 0 && $user_right == 0) { ?>

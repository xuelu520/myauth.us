...
<script>
    function submitcheck() {
        ...
        inputpass = encryptedString(key, inputpass);
        $("#password").val(inputpass);
        var inputpasscheck = $("#rePassword").val();
        setMaxDigits(131);
        var key = new RSAKeyPair("10001", '', rsa_n);
        inputpasscheck = encryptedString(key, inputpasscheck);
        $("#rePassword").val(inputpasscheck);
    }
</script>
                ...
                <form action="<?php echo SITEHOST ?>register.php" method="post" id="creation">
                    ...
                    <div class="input-row input-row-note" id="password-strength" style="display: none">
                        <div class="input-note border-5 glow-shadow">
                            <div class="input-note-left">
                                <p class="caption">为了您账号的安全，我们强烈建议您使用不同于战网、魔兽世界、星际争霸II、暗黑破坏神III、炉石传说、风暴英雄及其它任何线上账号密码的密码。</p>
                            </div>
                    ...
                    <div class="input-row input-row-text">
                        ...
                        <span class="input-right">
                            ...
                            <span class="input-text input-text-small">
                                <input type="text" name="letters_code" value="" onblur="if (!jquerycodechecked) {
                                            checkyanzhenma(this.value);
                                        }" id="letters_code" class="small border-5 glow-shadow-2" autocomplete="off" onpaste="return false;" maxlength="6" tabindex="1" required="required" placeholder="输入验证码" />
                    ...
                    <div class="input-row input-row-verification">
                        ...
                        <span class="input-right">
                            <span class="input-text">
                                <input id="lowright" onclick="if (this.checked) {
                                            return confirm('共享账号将无法查看令牌的序列号及还原码，仅可查看动态密码,如果你是自己使用,选中本选项将对你的使用造成极大不便.\n点确定注册共享账号,如果你看不懂前面的内容点取消.')
                                        }" type="checkbox" value="lowright" name="lowright"></input>
                            </span>
                            <label for="lowright" style="height: 32px;line-height:32px;overflow: hidden;">共享账号仅能查看动态密码，不能查看序列号及还原码等信息</label>
                        </span>
                    </div>  
                    ...
                    <div class="submit-row">
                        ...
                        <div class="input-right">
                            <button class="ui-button button1" type="submit"  onClick='javascript:return submitcheck();' id="creation-submit" tabindex="1">
                                <span class="button-left">
                                    <span class="button-right">免费注册战网安全令在线版账号</span>
                                </span>
                            </button>
                            <a class="ui-cancel "

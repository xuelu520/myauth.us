 ...
 */(function (e, t) {
    ...
    function t(t, n) {
        function g() {
            r.update(), b();
            var e = document.body.style, t = "userSelect"in e || "msUserSelect"in e || "MozUserSelect"in e || "webkitUserSelect"in e;
            return t || f.obj.attr("unselectable", "on"), r
        }
        function y() {
            var e = h.toLowerCase();
        ...
        function E(t) {
            if (o.ratio < 1) {
                ...
                if (n.lockscroll || p !== o[n.axis] - s[n.axis] && p !== 0)
                    r = e.event.fix(r), r.preventDefault(), n.slideCallback != null && n.slideCallback()
            }
        }
        function S(e) {
            o.ratio < 1 && (n.invertscroll && m ? d.now = Math.min(a[n.axis] - f[n.axis], Math.max(0, d.start + (v.start - (l ? e.pageX : e.pageY)))) : d.now = Math.min(a[n.axis] - f[n.axis], Math.max(0, d.start + ((l ? e.pageX : e.pageY) - v.start))), p = d.now * u.ratio, o.obj.css(c, -p), f.obj.css(c, d.now), n.slideCallback != null && n.slideCallback())
        }
        function x() {
        ...
        var r = this, i = t, s = {obj: e(n.viewportSelector, t)}, o = {obj: e(n.overviewSelector, t)}, u = {obj: e(n.scrollbarSelector, t)}, a = {obj: e(n.trackSelector, u.obj)}, f = {obj: e(n.thumbSelector, u.obj)}, l = n.axis === "x", c = l ? "left" : "top", h = l ? "Width" : "Height", p = 0, d = {start: 0, now: 0}, v = {}, m = "ontouchstart"in document.documentElement;
        return this.update = function (e) {
            s[n.axis] = s.obj[0]["offset" + h], o[n.axis] = o.obj[0]["scroll" + h], o.ratio = s[n.axis] / o[n.axis], u.obj.toggleClass("disable", o.ratio >= 1), a[n.axis] = n.size === "auto" ? s[n.axis] : n.size, f[n.axis] = Math.min(a[n.axis], Math.max(0, n.sizethumb === "auto" ? a[n.axis] * o.ratio : n.sizethumb)), f[n.axis] < n.minThumbSize && (f[n.axis] = n.minThumbSize, n.sizethumb = n.minThumbSize), u.ratio = n.sizethumb === "auto" ? o[n.axis] / a[n.axis] : (o[n.axis] - s[n.axis]) / (a[n.axis] - f[n.axis]), p = e === "relative" && o.ratio <= 1 ? Math.min(o[n.axis] - s[n.axis], Math.max(0, p)) : 0, p = e === "bottom" && o.ratio <= 1 ? o[n.axis] - s[n.axis] : isNaN(parseInt(e, 10)) ? p : parseInt(e, 10), y()
        }, g()
    }
    e.tiny = e.tiny || {}, e.tiny.scrollbar = {options: {axis: "y", wheel: 40, scroll: !0, lockscroll: !0, size: "auto", sizethumb: "auto", invertscroll: !1, trackSelector: ".track", thumbSelector: ".thumb", scrollbarSelector: ".scrollbar", viewportSelector: ".viewport", overviewSelector: ".overview", minThumbSize: 50, slideCallback: null}}, e.fn.tinyscrollbar = function (n) {
    ...
    e.effects = {effect: {}}, function (t, n) {
        ...
        function i(e) {
            ...
            return e = e.toLowerCase(), v(a, function (t, i) {
                ...
                if (u)
                    return s = n[a](u), n[l[a].cache] = s[l[a].cache], r = n._rgba = s._rgba, !1
            }), r.length ? (r.join() === "0,0,0,0" && t.extend(r, d.transparent), n) : d[e]
        }
        function s(e, t, n) {
            return n = (n + 1) % 1, n * 6 < 1 ? e + (t - e) * n * 6 : n * 2 < 1 ? t : n * 3 < 2 ? e + (t - e) * (2 / 3 - n) * 6 : e
        }
        var o = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "), u = /^([\-+])=\s*(\d+\.?\d*)/, a = [{re: /rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/, parse: function (e) {
        ...
        }, l = {rgba: {props: {red: {idx: 0, type: "byte"}, green: {idx: 1, type: "byte"}, blue: {idx: 2, type: "byte"}}}, hsla: {props: {hue: {idx: 0, type: "degrees"}, saturation: {idx: 1, type: "percent"}, lightness: {idx: 2, type: "percent"}}}}, c = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, h = f.support = {}, p = t("<p>")[0], d, v = t.each;
        p.style.cssText = "background-color:rgba(1,1,1,.5)", h.rgba = p.style.backgroundColor.indexOf("rgba") > -1, v(l, function (e, t) {
            t.cache = "_" + e, t.props.alpha = {idx: 3, type: "percent", def: 1}
        }), f.fn = t.extend(f.prototype, {parse: function (s, o, u, a) {
                if (s === n)
                    return this._rgba = [null, null, null, null], this;
                if (s.jquery || s.nodeType)
                    s = t(s).css(o), o = n;
                var c = this, h = t.type(s), p = this._rgba = [], m;
                o !== n && (s = [s, o, u, a], h = "array");
                if (h === "string")
                    return this.parse(i(s) || d._default);
                if (h === "array")
                    return v(l.rgba.props, function (e, t) {
                        p[t.idx] = r(s[t.idx], t)
                    }), this;
                if (h === "object")
                    return s instanceof f ? v(l, function (e, t) {
            ...
            if (e[0] == null || e[1] == null || e[2] == null)
                return[null, null, null, e[3]];
            var t = e[0] / 360, n = e[1], r = e[2], i = e[3], o = r <= .5 ? r * (1 + n) : r + n - r * n, u = 2 * r - o, a, f, l;
            ...
            }}, d = t.Color.names = {aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#808080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#808000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008080", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff"}
    }(jQuery), function () {
        function n() {
            ...
            if (t && t.length && t[0] && t[t[0]]) {
                s = t.length;
                while (s--)
                    r = t[s], typeof t[r] == "string" && (n[e.camelCase(r)] = t[r])
            } else
                for (r in t)
        ...
        function r(t, n) {
            var r = {}, i, o;
            for (i in n)
                o = n[i], t[i] !== o && !s[i] && (e.fx.step[i] || !isNaN(parseFloat(o))) && (r[i] = o);
            return r
        }
        var i = ["add", "remove", "toggle"], s = {border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1};
        ...
        e.extend(e.effects, {version: "1.9.0", save: function (e, t) {
                ...
                function u(t) {
                    ...
                    var r = e(this), i = a.complete, s = a.mode;
                    (r.is(":hidden") ? s === "hide" : s === "show") ? n() : c.call(r[0], a, n)
                }
                var a = i.apply(this, arguments), f = a.mode, l = a.queue, c = e.effects.effect[a.effect], h = !c && n && e.effects[a.effect];
                return e.fx.off || !c && !h ? f ? this[f](a.duration, a.complete) : this.each(function () {
                    a.complete && a.complete.call(this)
                }) : c ? l === !1 ? this.each(u) : this.queue(l || "fx", u) : h.call(this, {options: a, duration: a.duration, callback: a.complete, mode: a.mode})
    ...
    function n(t) {
        var n = [].slice.call(arguments, 1), r = 0, i = !0;
    ...
    window.Class = function () {
        ...
        e = !1;
        for (var s in n)
            typeof n[s] == "function" && typeof r[s] == "function" && t.test(n[s]) ? i[s] = function (e, t) {
                return function () {
                    var n = this._super;
                    this._super = r[e];
        ...
        return o.prototype = i, o.constructor = o, o.extend = this.callee || arguments.callee, o
    }
}();
var swfobject = function () {
    ...
    function _(n) {
        var r = null, i = R(n);
        if (i && i.nodeName.toUpperCase() == "OBJECT")
    ...
    function P(t, n, r, i) {
        ...
        var o = R(r);
        if (o) {
            o.nodeName.toUpperCase() == "OBJECT" ? (v = B(o), m = null) : (v = o, m = r), t.id = s;
    ...
    function j(n, r, s) {
        ...
        if (u) {
            ...
            if (T.ie && T.win) {
                ...
                u.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + a + ">" + l.replace(/&/g, "&amp;") + "</object>", p[p.length] = n.id, o = R(n.id)
            } else {
                var h = U(t);
    ...
    function I(e) {
        var t = R(e);
        t && t.nodeName.toUpperCase() == "OBJECT" && (T.ie && T.win ? (t.style.display = "none", function () {
